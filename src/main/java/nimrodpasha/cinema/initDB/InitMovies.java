...
public class InitMovies {
    ...
    public static void main(String[]args){
        ...
        movies.add(new MovieDetails(8,"The Mask","Stanley Ipkiss (Jim Carrey) is a bank clerk that is an incredibly nice man. Unfortunately," +
                ...
                IMAGE_FOLDER+"MASK.jpg","Chuck Russell","Jim Carrey as Stanley Ipkiss/The Mask,Cameron Diaz as Tina Carlyle,Amy Yasbeck as Peggy Brandt,Joely Fisher as Maggie","1994","Action,Comedy,CrimeAction,Family,Fantasy","88 min", fillScreeningInstanceArrayInterface.fillScreeningInstanceArray()));
