...
public class InitTheater {
    ...
    public static void main(String[]args) {
        ...
        theaters.add(new Theater(1, "1", 10, 10, "Haifa", Parameters.IMAGE_FOLDER+"theater_1.jpg"));
        theaters.add(new Theater(2, "2", 7, 11, "Haifa", Parameters.IMAGE_FOLDER+"theater_2.jpg"));
        theaters.add(new Theater(3, "3", 8, 5, "Haifa", Parameters.IMAGE_FOLDER+"theater_3.jpg"));
        theaters.add(new Theater(4, "4", 9, 10, "Haifa", Parameters.IMAGE_FOLDER+"theater_4.jpg"));
        theaters.add(new Theater(5, "5", 10, 6, "Haifa", Parameters.IMAGE_FOLDER+"theater_5.jpg"));
        theaters.add(new Theater(6, "6", 5, 5, "Haifa", Parameters.IMAGE_FOLDER+"theater_6.jpg"));
        theaters.add(new Theater(7, "7", 11, 4, "Haifa", Parameters.IMAGE_FOLDER+"theater_7.png"));
        theaters.add(new Theater(8, "8", 4, 8, "Haifa", Parameters.IMAGE_FOLDER+"theater_8.jpg"));
        theaters.add(new Theater(9, "9", 4, 5, "Haifa", Parameters.IMAGE_FOLDER+"theater_9.jpg"));
        theaters.add(new Theater(10, "10", 5, 5, "Haifa", Parameters.IMAGE_FOLDER+"theater_10.jpg"));
        theaters.add(new Theater(11, "11", 10, 10, "Haifa", Parameters.IMAGE_FOLDER+"theater_11.jpg"));
        theaters.add(new Theater(12, "12", 12, 7, "Haifa", Parameters.IMAGE_FOLDER+"theater_12.jpg"));
         //TODO remove imageLink and location...
