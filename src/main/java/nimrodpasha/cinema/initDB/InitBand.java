...
public class InitBand {
    ...
    public static void main(String[]args){
        ...
        bands.add(new Band(1,"Fast and Furious 8","After Dom is recruited by a mysterious villainess hacker," +
                ...
                IMAGE_FOLDER+"fast8.jpg"));
        //TODO add ,"2017","Vin Diesel, Jason Statham, Dwayne Johnson, Michelle Rodriguez, Tyrese Gibson","F. Gary Gray","Action, Thriller, Crime","136 min",
        ...
        bands.add(new Band(2,"McLaren","The story of Bruce McLaren, the New Zealander who founded the McLaren Motor Racing team. " +
                ...
                " Now, the crew must unite to bring home the man who made them a family and stop her from unleashing chaos on a grand scale.",
                IMAGE_FOLDER+"Maclaren.jpg"));

        //TODO add ,"2017"," Mario Andretti, Alastair Caldwell, Dwayne Cameron","Roger Donaldson","Documentary, Action,  Drama","92 min",
        ...
        bands.add(new Band(3,"Pink Panther","The Pink Panther diamond is stolen once again from Lugash and the authorities call in Chief Inspector Clouseau from France." +
                ...
                IMAGE_FOLDER+"PimkPanter.jpg"));

           //TODO add ,"1982", "Julie Andrews ,Denise Crosby,Claudia Cardinale ","Blake Edwards","Comedy, Crime, Mystery","62 min",
        ...
        bands.add(new Band(4,"Kung Fu Panda 3","When Po's long-lost panda father suddenly reappears, the reunited duo travels to a secret panda paradise to meet scores of hilarious new panda characters." +
                ...
                IMAGE_FOLDER+"Panda.jpg"));
         //TODO add ,"2017","Angelina Jolie as Tigress,Seth Rogen as Mantis,Bryan Cranston as Li,Kate Hudson as Mei Mei","Jennifer Yuh","Action,Animation,Comedy,Family,Fantasy","88 min",
        ...
        //TODO add ,"2017","Rosario Dawson as Batgirl,Channing Tatum as Superman,Ralph Fiennes as Alfred Pennyworth,Zoë Kravitz as Catwoman","Chris McKay","Action,Animation,Family,Fantasy","76 min",
        ...
        bands.add(new Band(6,"Kong: Skull Island","A washed up monster chaser convinces the U.S. Government to fund a trip to an unexplored island in the South Pacific. " +
                ...
                " just maybe, learn to lighten up.",
                IMAGE_FOLDER+"KONG.jpg"));
        //TODO add ,"2017","Brie Larson as Mason Weaver,Tom Hiddleston as James Conrad,Samuel L. Jackson as Preston Packard","Jordan Vogt-Roberts","Action,Adventure,Fantasy,Sci-Fi","102 min",
        ...
        bands.add(new Band(7,"CHIPS","Jon Baker (Shepard) and Frank Ponch Poncherello (Peña) have just joined the California Highway Patrol (CHP) in Los Angeles, but for very different reasons." +
                ...
                IMAGE_FOLDER+"CHIPS.jpg"));
        //TODO add ,"2017","Kristen Bell as Karen,	Rosa Salazar as Ava,Vincent D'Onofrio as Vic Brown","Dax Shepard","Action,Comedy,Crime","84 min",
        ...
        bands.add(new Band(8,"The Mask","Stanley Ipkiss (Jim Carrey) is a bank clerk that is an incredibly nice man. Unfortunately," +
                ...
                IMAGE_FOLDER+"MASK.jpg"));
        //TODO add ,"1994","Jim Carrey as Stanley Ipkiss/The Mask,Cameron Diaz as Tina Carlyle,Amy Yasbeck as Peggy Brandt,Joely Fisher as Maggie","Chuck Russell","Action,Comedy,CrimeAction,Family,Fantasy","88 min",
