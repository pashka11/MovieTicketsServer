...
public class Parameters {
    ...
    public static final String DOES_NOT_EXIST = "resource does not exists";
    public static final String RESOURCE_IS_IN_USE = "resource is in use";
    public static final String RESOURCE_HAS_BEEN_DELETED = "resource has been deleted";
