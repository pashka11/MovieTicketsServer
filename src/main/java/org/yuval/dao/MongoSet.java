...
public class MongoSet {
    ...
    public static void setTicket(int row, int column, String showInstanceID, String user) {
        ...
        DBObject object = new BasicDBObject(USER_TICKETS,new BasicDBObject(USER_SHOW_INSTANCE_ID,showInstanceID).append(USER_TICKETS_FOR_INSTANCE, Arrays.asList(rowColumnNameInterface.rowNumberToName(row) +
                " " + rowColumnNameInterface.columnNumberToName(column))));
