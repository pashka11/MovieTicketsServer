...
import static org.yuval.utils.Helpers.fillShowInstanceArray;
...
public class InitShow {
    ...
    public static void main(String[] args) {
        ...
        shows.add(new Show(1, "Great rock show", "The party will roll all night long during the North American " +
                ...
                "open each night and between acts before we hit the stage.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_1.jpg"));
        ...
        shows.add(new Show(2, "Best show ever", "From the late 1960s to the early 1970s, many rock and roll " +
                ...
                " music.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_2.jpg"));
        ...
        "d after a quick group huddle the band obliged and delivered a powerful performance of the song.", new BandDao().randomId(), fillShowInstanceArray()
                ...
                shows.add(new Show(4,"Woodstock","This lineup of the band has been together since 2012. This version includes " +
                        ...
                        , new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_4.jpg"));
        ...
        shows.add(new Show(5,"Europe tour","Marillion played their first US tour since 2012. The show featured opener John Wesley " +
                ...
                "“Easter”both of which received the loudest ovations of the night.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_5.jpg"));
        ...
        shows.add(new Show(6,"Africa tour","The recently inducted member to the Rock and Roll Hall of Fame is never at a loss for words." +
                ...
                "treats ending with “The Stake” and “Jet Airliner” were icing on the cake.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_6.jpg"));
        ...
        shows.add(new Show(7,"Middle east tour","John Fogerty has been around a very long time. During the earlier years of" +
                ...
                " Do not miss this guy if he comes to your area.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_7.jpg"));
        ...
        shows.add(new Show(8,"Big in japan","Olivia has yet to ever disappoint and this was no exception. She gives everyone a " +
                ...
                " “Please Mr. Please” and “Have You Never Been Mellow” was worth the price of admission alone.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_8.jpg"));
        ...
        shows.add(new Show(9,"Styx","Having seen Styx numerous times over recent years and never once seeing the" +
                ...
                "“Lights” from Cornerstone were the icing on the cake.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_9.jpg"));
        ...
        shows.add(new Show(10,"Rock n' Roll","One of the most anticipated tours of the fall landed in town in early" +
                ...
                " an extremely enjoyable evening for everyone in attendance.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_10.jpg"));
        ...
        shows.add(new Show(11,"Another one bite the dust","The Fallsview Casino welcomed the voice of Starship Mickey Thomas. There really isn’t " +
                ...
                "“Nothing’s Gonna Stop Us Now” was nothing less than extraordinary.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_11.jpg"));
        ...
        shows.add(new Show(12,"Rock Hard","Everything about this night was spot on in regards to the weather, atmosphere and ambiance. While singer David Coverdale" +
                ...
                " great songs and one that took many back to remember the glory days of their past.", new BandDao().randomId(), fillShowInstanceArray(),IMAGE_FOLDER+"rock_show_12.jpg"));

        ShowDao showDao = new ShowDao();
        showDao.dropAll();

        shows.parallelStream()
                .forEach(show -> showDao.create(show));
