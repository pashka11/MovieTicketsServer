...
public class ImageService {
     ...
     */
    private static final java.nio.file.Path BASE_DIR = Paths.get("C:\\Users\\Yuval\\IdeaProjects\\TicketServer\\src\\main\\resources\\Images");
...
//        JsonArrayBuilder results = Json.createArrayBuilder();
    ...
    public Response uploadImage(InputStream in, @HeaderParam("Content-Type") String fileType, @HeaderParam("Content-Length") long fileSize) throws IOException {
        ...
        return Response.status(Status.CREATED).entity(IMAGE_FOLDER+fileName).build();
    }
